...
This chapter covers [issue #13](https://github.com/dermellor/ganttry/issues/13).
...
[#14](https://github.com/dermellor/ganttry/issues/14), which is also where the
...
gate in front of the catalog ([#15](https://github.com/dermellor/ganttry/issues/15)).
